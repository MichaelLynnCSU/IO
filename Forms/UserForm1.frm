...
If ComboBox1.Value = "NJH" Then
 ...
 'Hardcoded inputs for testing purposes only. Delete when finished.
  ...
  ThisWorkbook.Sheets("File Paths").Cells(5, 2).Value2 = "\\nas-longmont\Project\Customer\LSI\LSI001 - TVA IROCS\07 - IO List Tool\NJH\Exported Data Files\Nickajack_Plant_NJH_CH_AI_Meas_Mon_Alarming.csv"
  ...
  ThisWorkbook.Sheets("File Paths").Cells(7, 2).Value2 = "\\nas-longmont\Project\Customer\LSI\LSI001 - TVA IROCS\07 - IO List Tool\NJH\Exported Data Files\Nickajack_Plant_NJH_WR_X_SBO.csv"
  
  ThisWorkbook.Sheets("File Paths").Cells(8, 1).Value2 = "RD_X_AI1 - Rack 1"
  ThisWorkbook.Sheets("File Paths").Cells(8, 2).Value2 = "\\nas-longmont\Project\Customer\LSI\LSI001 - TVA IROCS\07 - IO List Tool\NJH\Exported Data Files\Nickajack_Plant_NJH_RD_X_AI1.csv"
  
  ThisWorkbook.Sheets("File Paths").Cells(9, 1).Value2 = "RD_X_SOE - Rack 1"
  ThisWorkbook.Sheets("File Paths").Cells(9, 2).Value2 = "\\nas-longmont\Project\Customer\LSI\LSI001 - TVA IROCS\07 - IO List Tool\NJH\Exported Data Files\Nickajack_Plant_NJH_RD_X_SOE.csv"
  
  ThisWorkbook.Sheets("File Paths").Cells(10, 1).Value2 = "RD_X_SOE_Message"
  ThisWorkbook.Sheets("File Paths").Cells(10, 2).Value2 = "\\nas-longmont\Project\Customer\LSI\LSI001 - TVA IROCS\07 - IO List Tool\NJH\Exported Data Files\Nickajack_Plant_NJH_RD_X_SOE_Messages.csv"
  
  ThisWorkbook.Sheets("File Paths").Cells(11, 1).Value2 = "CH_DI_Singals"
  ThisWorkbook.Sheets("File Paths").Cells(11, 2).Value2 = "\\nas-longmont\Project\Customer\LSI\LSI001 - TVA IROCS\07 - IO List Tool\NJH\Exported Data Files\Nickajack_Plant_NJH_CH_DI_Signals.csv"
  
  ThisWorkbook.Sheets("File Paths").Cells(12, 1).Value2 = "CH_DI"
  ThisWorkbook.Sheets("File Paths").Cells(12, 2).Value2 = "\\nas-longmont\Project\Customer\LSI\LSI001 - TVA IROCS\07 - IO List Tool\NJH\Exported Data Files\Nickajack_Plant_NJH_CH_DI.csv"
  
  ThisWorkbook.Sheets("File Paths").Cells(13, 1).Value2 = "Message_Block"
  ThisWorkbook.Sheets("File Paths").Cells(13, 2).Value2 = "\\nas-longmont\Project\Customer\LSI\LSI001 - TVA IROCS\07 - IO List Tool\NJH\Exported Data Files\Nickajack_Plant_NJH_CH_DI_Message_Block.csv"
